...
var classification = function (spec,my) {
	...
	// check whether the required survey fields are filled out
	my.check_survey = function () {
		if ( tu.emptyField('survey_txt_country',my.list_survey_txt) || tu.emptyField('survey_txt_native_lang',my.list_survey_txt) ) {
			alert('A required field was not filled out.');
			return false;
		}
		if ( tu.emptyField('survey_radio_scroll',my.list_survey_radio) ) {
